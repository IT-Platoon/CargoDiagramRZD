...
async def create_document(
    ...
    for index, cargo in enumerate(result['cargo'], start=1):
        ...
        doc.add_paragraph(f"Длина {cargo['length']} мм", style='List Bullet 2')
        doc.add_paragraph(f"Ширина {cargo['width']} мм", style='List Bullet 2')
        doc.add_paragraph(f"Высота {cargo['height']} мм", style='List Bullet 2')
        doc.add_paragraph(f"Масса {cargo['weight']} т", style='List Bullet 2')
